...
- **Use the word ‘onchain’** instead of ‘web3’ or ‘crypto’ — and it's spelled "onchain" or "Onchain", not "on-chain", "on chain", or "On Chain"
...
- [Oxford Comma](https://thewritelife.com/is-the-oxford-comma-necessary/) - Base uses the **Oxford comma**. For example:
  - ❌ apples, oranges and bananas (no Oxford comma)
